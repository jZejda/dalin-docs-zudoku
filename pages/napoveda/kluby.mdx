...
Stránka **Kluby** (menu **Nastavení → Nastavení závodů → Kluby**, `/admin/config/clubs`) je číselník oddílů orientačního běhu — nejde o nastavení *vašeho* klubu, ale o sdílený seznam všech oddílů (typicky v rámci kraje/oblasti), který se používá jinde v systému, například při přiřazování klubu k závodníkovi nebo k závodu.

![Přehled klubů v Nastavení](./img/nastaveni-kluby.png)

...
Ta zmizela a s tím se uvolnilo místo pro obsah, vše ostatní se přesunulo do levého menu včetně odkazu uživatele:
...
- V horní části menu je tlačítko na přepínání jazyka. Systém plně komunikuje v češtině a angličtině.
